...
// COMETARIO ENCABEZADO + COMENTAR CODIGO
...
int main(){
    ...
    int alpha_loaded_floors = 0;
    int beta_loaded_floors = 0;
    int gamma_loaded_floors = 0;
        ...
        if(option == 'A' || option == 'a'){
            ...
            while((from == to) && (option == 'a' || option == 'A')){
                ...
                if(from != to){
                    ...
                    int alpha_from, beta_from, gamma_from;
                    ...
                    if (diference_alpha > 0){
                        alpha_from = diference_alpha;
                    }else{
                        alpha_from = diference_alpha * -1;
                    }

                    if (diference_beta > 0){
                        beta_from = diference_beta;
                    }else{
                        beta_from = diference_beta * -1; 
                    }

                    if (diference_gamma > 0){
                        gamma_from = diference_gamma;
                    }else{
                        gamma_from = diference_gamma * -1;
                    }
                    ...
                    if((alpha_from < beta_from && alpha_from < gamma_from) || 

                    ((gamma_from > alpha_from) && (alpha_from == beta_from && alpha_loaded_floors < beta_loaded_floors))  ||
                    ((beta_from > alpha_from) && (alpha_from == gamma_from && alpha_loaded_floors < gamma_loaded_floors)) ||

                    ((gamma_from > alpha_from) && (alpha_from == beta_from && alpha_loaded_floors == beta_loaded_floors)) ||
                    ((beta_from > alpha_from) && (alpha_from == gamma_from && alpha_loaded_floors == beta_loaded_floors))){

                        char selected_elevator = 'A';
                        alpha_loaded_floors += abs(to_int - from_int);
                    ...
                    if ((beta_from < alpha_from && beta_from < gamma_from) ||
                    
                    ((gamma_from > beta_from) && (beta_from == alpha_from && beta_loaded_floors < alpha_loaded_floors)) ||
                    ((alpha_from > beta_from) && (beta_from == gamma_from && beta_loaded_floors < gamma_loaded_floors)) ||
                    
                    ((alpha_from > beta_from) && (beta_from == gamma_from && beta_loaded_floors == gamma_loaded_floors))){


                        selected_elevator = 'B';
                        beta_loaded_floors += abs(to_int - from_int);
                    ...
                    if ((gamma_from < alpha_from && gamma_from < beta_from) ||                     
                    
                    ((beta_from > gamma_from) && (gamma_from == alpha_from && gamma_loaded_floors < alpha_loaded_floors)) ||
                    ((alpha_from > gamma_from) && (gamma_from == beta_from && gamma_loaded_floors < beta_loaded_floors))){
 
                        selected_elevator = 'G';
                        gamma_loaded_floors += abs(to_int - from_int);
