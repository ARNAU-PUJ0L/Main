...
-- Design Ports Information
-- data_out[0]	=>  Location: PIN_V8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data_out[1]	=>  Location: PIN_Y8,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data_out[2]	=>  Location: PIN_Y7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- data_out[3]	=>  Location: PIN_P9,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- sel	=>  Location: PIN_V7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- BN[0]	=>  Location: PIN_Y5,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- BN[1]	=>  Location: PIN_Y6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- BN[2]	=>  Location: PIN_W9,	 I/O Standard: 2.5 V,	 Current Strength: Default


ARCHITECTURE structure OF BN_conv IS
SIGNAL gnd : std_logic := '0';
SIGNAL vcc : std_logic := '1';
SIGNAL unknown : std_logic := 'X';
...
-- Equation(s):
-- \data_out~0_combout\ = (\sel~input_o\ & (\BN[2]~input_o\ $ (((\BN[0]~input_o\) # (\BN[1]~input_o\))))) # (!\sel~input_o\ & (\BN[0]~input_o\ $ (((\BN[1]~input_o\)))))

-- pragma translate_off
GENERIC MAP (
	lut_mask => "0001110101101010",
	sum_lutc_input => "datac")
-- pragma translate_on
PORT MAP (
	dataa => \BN[0]~input_o\,
...
-- Equation(s):
-- \data_out~1_combout\ = \BN[2]~input_o\ $ (\BN[1]~input_o\)
...
-- Equation(s):
-- \data_out~2_combout\ = \BN[2]~input_o\ $ (((\BN[0]~input_o\ & (\sel~input_o\ & \BN[1]~input_o\))))
...
-- Equation(s):
-- \data_out~3_combout\ = (\BN[2]~input_o\ & \sel~input_o\)
